# QAX Real Experience · APIs Playwright

Repositorio de automatización para pruebas de **APIs** usando **Playwright**, dentro del programa **QAX Real Experience** de **QAXpert**.
